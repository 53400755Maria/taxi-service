...
DEFAULT_DRIVERS = [
    {"id": "1", "name": "Иван Петров", "car": "Kia Rio 2020", "phone": "+7 (912) 345-67-89", "rating": 4.8},
    {"id": "2", "name": "Анна Сидорова", "car": "Hyundai Solaris 2021", "phone": "+7 (923) 456-78-90", "rating": 4.9},
    {"id": "3", "name": "Сергей Иванов", "car": "Skoda Octavia 2019", "phone": "+7 (934) 567-89-01", "rating": 4.7},
    {"id": "4", "name": "Мария Кузнецова", "car": "Toyota Camry 2022", "phone": "+7 (945) 678-90-12", "rating": 5.0}
]
...
def create_order():
    try:
        ...
        return jsonify({
            'success': True,
            'order_id': order['id'],
            'driver': {'name': driver['name'], 'car': driver['car'], 'phone': driver['phone']},
            'price': price,
...
def get_drivers():
    return jsonify({'success': True, 'count': len(load_drivers()), 'drivers': load_drivers()})
